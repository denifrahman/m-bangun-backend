    ...
    init: function() {
        ! function() {
            $("#m_daterangepicker_1, #m_daterangepicker_1_modal").daterangepicker({
                ...
                $("#m_daterangepicker_4 .form-control").val(a.format("DD/MM/YYYY h:mm A") + " / " + t.format("DD/MM/YYYY h:mm A"))
                ...
                $("#m_daterangepicker_5 .form-control").val(a.format("DD/MM/YYYY") + " / " + t.format("DD/MM/YYYY"))
            });
