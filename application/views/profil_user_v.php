...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
              ...
              <div class="m-portlet m-portlet--full-height  ">
                <div class="m-portlet__body">
                      ...
                      <h5 class="m-subheader__title m--font-light"">Upload Lembar Jawaban</h5>
                        ...
                        <?php if ($data_user->foto_profile == null) { ?>
                          <div class="m-card-profile__pic">
                            ...
                            <input type="hidden" name="id_user" value="<?= $this->session->userdata('data_profil')->id ?>">
                        ...
                        <?php } else { ?>
                          <div class="m-card-profile__pic">
                            <div class="m-card-profile__pic-wrapper">
                              <img src="<?= base_url() ?>assets/img/profile/<?= $data_user->foto_profile ?>" alt="">
                            </div>
                            <div class="col-lg-12" style=" float: none;margin: 0 auto;">
                              <button type="button" class="btn m-btn--pill btn-secondary btn-sm m--font-danger" onclick="hapus('<?= $data_user->id ?>','<?= $data_user->foto_profile ?>')">Hapus</button>
                            </div>
                          </div>
                        <?php } ?>
                  ...
                  <div class="m-card-profile__details">
                    <span class="m-card-profile__name"><?= $data_user->nama; ?></span>
                    <a href="" class="m-card-profile__email m-link"><?= $data_user->username; ?></a>
                  </div>
                </div>
                  ...
                  <form class="m-form m-form--fit m-form--label-align-right" id="formMaster">
                    <div class="m-portlet__body">
                      ...
                      <div class="form-group m-form__group row">
                        ...
                        <div class="col-7">
                          <input class="form-control m-input" id="nama" name="nama" type="text" value="<?= $data_user->nama ?>">
                      ...
                      <div class="form-group m-form__group row">
                        ...
                        <div class="col-7">
                          <input class="form-control m-input" type="text" value="<?= $data_user->username ?>" id="username" name="username" disabled>
                        </div>
                      </div>
                      <div class="form-group m-form__group row">
                        <label for="example-text-input" class="col-2 col-form-label">Phone No.</label>
                        <div class="col-7">
                          <input class="form-control m-input" type="text" value="<?= $data_user->no_telp ?>" id="no_telp" name="no_telp">
                        </div>
                      </div>
                      ...
                      <div class="form-group m-form__group row">
                        ...
                        <div class="col-7">
                          <input class="form-control m-input" type="text" value="<?= $data_user->alamat ?>" id="alamat" name="alamat">
                        </div>
                      </div>
                      <div class="m-form__seperator m-form__seperator--dashed m-form__seperator--space-2x"></div>
                      <div class="form-group m-form__group row">
                      ...
                      <div class="form-group m-form__group row">
                        ...
                        <div class="col-7">
                          <input class="form-control m-input" type="text" value="<?= $data_user->password ?>" id="password" name="password">
                        </div>
                      </div>
                    </div>
  ...
  <script>
    const id_user = "<?= $this->session->userdata('data_profil')->id ?>"
    ...
    $(document).ready(function() {
      ...
      $('#submit').submit(function(e) {
        ...
        e.preventDefault();
        var id = $("#id").val();
        url = "<?= base_url() ?>/profil_user/upload",
          type = "POST"
        $.ajax({
          url: url,
          type: "post",
    ...
    function simpan_verifikasi(id) {
      ...
      if (!$valid) {
        ...
        var type = "";
        if (id == 'undefined') {
          url = "<?= API_GET ?>/m_user/ubah_profile",
            type = "POST"
        } else {
          url = "<?= API_GET ?>/m_user/ubah_profile",
            type = "POST"
    ...
    function hapus(id, nama) {
      swal({
        ...
        if (e.value) {
          ...
          $.ajax({
            method: 'GET',
            url: base_url + 'profil_user/delete_by_id/' + id + '/' + nama,
    ...
    function getTable(id) {
      ...
      table = $("#table_view_nilai").DataTable({
        ...
        "ajax": {
          "url": "<?= API_GET ?>/t_nilai_user/get_all/",
          "type": "POST",
          "data": {
            "id_user": id_user
          }
      ...
      $("#title_modal_tambah_user").text('Tagihan user');
      swal.close();
    }
  </script>
